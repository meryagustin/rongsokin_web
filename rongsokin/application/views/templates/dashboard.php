...
<head>
    ...
    <title><?= $title; ?> | Informasi Sistem Persediaan Barang</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">RONGSOKIN</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan Sampah</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Jenis Sampah</a>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Sampah</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span> Sistem Rongsokan sampah </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
