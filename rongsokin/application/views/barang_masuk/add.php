        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_masuk">ID Transaksi Sampah Masuk</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="supplier_id">Pelanggan</label>
                    <div class="col-md-5">
