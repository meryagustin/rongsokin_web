        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_keluar">ID Transaksi Sampah Keluar</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="barang_id">Sampah</label>
                    <div class="col-md-5">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tujuan">Tujuan</label>
                    <div class="col-md-5">
                        <input value="<?= set_value('tujuan'); ?>" name="tujuan" id="tujuan" type="text" class="form-control" placeholder="Tujuan...">
                ...
                <input value="<?= set_value('harga'); ?>" name="harga" id="harga" type="number" step="1000" class="form-control" placeholder="Harga...">
                </div>
